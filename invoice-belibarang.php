<?php
  ...
  $sqlss= "select SUM(jumlah) as jumlah from tbpembelianbarang_detail where tbpembelianbarang_detail.idorder = '$kodedecrypt'";
  $qryss= mysql_query($sqlss);
  $rowsss= mysql_fetch_assoc($qryss);
  $wdw = $rowsss['jumlah'];
  $upd = "UPDATE tbpembelianbarang SET total='$wdw' WHERE idorder='$kodedecrypt'";
                        ...
                        <div class="block-content">
                            ...
                            <div class="row my-20">
                                ...
                                <div class="col-6 text-right">
                                        <?php
                                           $sql= "SELECT tbpembelianbarang.tglmasuk, tbsupplier.nama abc, tbsupplier.alamat al, tbsupplier.nohp hp FROM tbpembelianbarang 
                                           JOIN tbsupplier on tbpembelianbarang.idsupplier = tbsupplier.idsupplier
                                           where idorder = '$kodedecrypt'";
                                           $qry= mysql_query($sql);
                                           $rows= mysql_fetch_assoc($qry);
                                           $daste = $rows['tglmasuk'];
                                        ?>
                                    <p class="h3"><?php echo $rows['abc']; ?></p>
                                    <address>
                            ...
                            <div class="table-responsive push">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            $no = 1;
                                            $sql= "SELECT tbpembelianbarang_detail.idbarang awdws, tbbarang.nama a,tbbarang.stok swq,tbpembelianbarang_detail.stok b,tbpembelianbarang_detail.jumlah, tbbarang.merk c 
                                            FROM tbpembelianbarang_detail JOIN tbbarang ON tbpembelianbarang_detail.idbarang=tbbarang.idbarang 
                                            where tbpembelianbarang_detail.idorder='$kodedecrypt'
                                            ";
                                            $qry= mysql_query($sql);
